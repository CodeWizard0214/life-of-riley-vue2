...
<template>
  <div class="sticky-footer-mobile d-block d-lg-none">
    <div class="row align-items-center">
      <div class="col-6">
        <template v-if="authenticated">
          <button
            type="button"
            class="addbucketlist text-center"
      ...
      <div class="col-6">
        <!-- <button class="experience-view-button" type="button">View Experience</button> -->
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        >
          <div class="modal-body text-left">
            <button class="btn btn-danger float-right" v-on:click="toggleTransferModal">X</button>
            <h2
              class="modal-title"
              id="eventPopupModalTitle"
            >Before we transfer you to {{ event.name }}</h2>
            <p>
